...
<tr key={country.country}>
  <td className="sorting_1">
    <img className="chat-img mr-2" src={"https://www.countryflags.io/"+country.countryInfo.iso2+"/flat/64.png"}
      alt="" /><span>{country.country}</span>
  </td>
  <td>
  ...
  <div className="row">
    <div className="col-lg-8 box-margin">
      <div className="card code-table">
        <div className="card-body pb-0" style={{paddingLeft:"0"}}>
          <div
            className="card-header border-none bg-transparent d-flex align-items-center justify-content-between p-0 mb-30">
          ...
          <div className="table-responsive">
            <table className="table table-hover table-nowrap table-dark">
              ...
              <tbody>
                {(this.props.countryDataByCases.length > 0) ? this.generateCountryList(this.props.countryDataByCases) :
                <Loader />}
              </tbody>
            </table>
          </div>
    ...
    <div className="col-lg-4 box-margin height-card">
      <div className="container">
        <div class="col-12">
          <h4 class="card-title mb-1">COVID-19 | Symptoms</h4>
        </div>
        <div className="row">
          <div className="col-md-6">
            <div className="virus-symptoms-card ">
          ...
          <img src="https://www.aljazeera.com/mritems/Images/2020/3/26/451e58ab10d84c018ba12d23bb8df844_18.jpg" style={{width:"97%"}}/>
        </div>
